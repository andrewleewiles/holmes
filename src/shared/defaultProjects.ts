 ...
 */
export type ProjectKind = 'standard' | 'library'
...
export function projectKindForCategory(category: DefaultProjectCategory): ProjectKind {
  return category === 'media' ? 'library' : 'standard'
}
